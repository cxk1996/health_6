...
public class MessageConstant {
    ...
    public static final String GET_USER_FAIL = "查询用户数据失败";
    public static final String GET_USER_SUCCESS = "查询用户数据成功";
    public static final String GET_ROLE_FAIL = "查询用户数据失败";
    public static final String GET_ROLE_SUCCESS = "查询用户数据成功";
